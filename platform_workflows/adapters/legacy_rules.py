# Legacy rule engine adapter — DB trigger→action rules.
...
class LegacyRuleEngineAdapter:
    """Migration adapter for legacy workflow_rules / workflow_logs."""
...
LegacyRuleEngineAdapter.register_action("send_notification", _default_send_notification)
LegacyRuleEngineAdapter.register_action("create_task", _action_create_task)
LegacyRuleEngineAdapter.register_action("create_calendar_event", _action_create_calendar_event)
LegacyRuleEngineAdapter.register_action("notify_client", _action_notify_client)
LegacyRuleEngineAdapter.register_action("notify_participants", _action_notify_participants)

legacy_rule_engine = LegacyRuleEngineAdapter()
WorkflowEngine = LegacyRuleEngineAdapter
