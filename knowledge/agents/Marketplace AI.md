...
## Overview
**Marketplace AI** — listings, pricing, recommendations. Status: `active`. Layer: `auto/agro`.
...
## Responsibilities
Listings, pricing, recommendations. Must respect bridge-only integration and safe-use policies (especially engineering agents).
