...
## Overview
**Finance AI** — billing, tariffs, financial ops. Status: `documented`. Layer: `application`.
...
## Responsibilities
Billing, tariffs, financial ops. Must respect bridge-only integration and safe-use policies (especially engineering agents).
