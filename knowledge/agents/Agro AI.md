...
## Overview
**Agro AI** — agro trading, forecasting, quality. Status: `active`. Layer: `agro`.
...
## Responsibilities
Agro trading, forecasting, quality. Must respect bridge-only integration and safe-use policies (especially engineering agents).
