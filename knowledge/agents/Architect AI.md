...
## Overview
**Architect AI** — architecture review & system design. Status: `documented`. Layer: `platform`.
...
## Responsibilities
Architecture review & system design. Must respect bridge-only integration and safe-use policies (especially engineering agents).
