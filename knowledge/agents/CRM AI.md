...
## Overview
**CRM AI** — sales pipeline & customer intelligence. Status: `active`. Layer: `crm`.
...
## Responsibilities
Sales pipeline & customer intelligence. Must respect bridge-only integration and safe-use policies (especially engineering agents).
