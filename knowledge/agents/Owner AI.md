...
## Overview
**Owner AI** — executive ownership & portfolio decisions. Status: `documented`. Layer: `ecosystem`.
...
## Responsibilities
Executive ownership & portfolio decisions. Must respect bridge-only integration and safe-use policies (especially engineering agents).
