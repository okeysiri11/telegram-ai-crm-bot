...
## Overview
**QA AI** — quality assurance & regression guidance. Status: `documented`. Layer: `platform`.
...
## Responsibilities
Quality assurance & regression guidance. Must respect bridge-only integration and safe-use policies (especially engineering agents).
