...
## Overview
**Legal AI** — legal agent / compliance scaffold. Status: `scaffold`. Layer: `vertical`.
...
## Responsibilities
Legal agent / compliance scaffold. Must respect bridge-only integration and safe-use policies (especially engineering agents).
