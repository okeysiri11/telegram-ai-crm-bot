...
## Overview
**Manager AI** — delivery management & sprint coordination. Status: `documented`. Layer: `ecosystem`.
...
## Responsibilities
Delivery management & sprint coordination. Must respect bridge-only integration and safe-use policies (especially engineering agents).
