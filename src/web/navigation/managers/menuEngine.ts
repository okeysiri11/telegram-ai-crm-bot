...
const menu: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "nav_pb_builder_studio", name: "AI Builder Studio", icon: "ai", route: "/platform-builder/builder-studio", module: "platform_builder", permissions: ["read"], status: "active" },
      ...
      { id: "nav_pb_workflow_center", name: "Workflow Center", icon: "workflow", route: "/platform-builder/workflow-center", module: "platform_builder", permissions: ["read"], status: "active" },
      { id: "nav_enterprise_city", name: "Enterprise City", icon: "analytics", route: "/enterprise-city", module: "platform_builder", permissions: ["read"], status: "active" },
      ...
      { id: "nav_pb_learning", name: "Learning", icon: "analytics", route: "/platform-builder/learning", module: "platform_builder", permissions: ["read"], status: "active" },
      { id: "nav_pb_okr", name: "OKR Intelligence", icon: "analytics", route: "/platform-builder/okr", module: "platform_builder", permissions: ["read"], status: "active" },
      { id: "nav_pb_governance", name: "Governance", icon: "security", route: "/platform-builder/governance", module: "platform_builder", permissions: ["read"], status: "active" },
