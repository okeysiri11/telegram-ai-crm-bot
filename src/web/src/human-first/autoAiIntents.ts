...
export const AUTO_AI_INTENTS: AiNavigationIntent[] = [
  {
    ...
    type: "create",
    route: "/workspace/auto?view=vehicles&action=vehicle",
  ...
  },
  {
    ...
    type: "create",
    route: "/workspace/auto?view=purchases",
    label: "Закупки",
  },
  {
    ...
    type: "navigate",
    route: "/workspace/auto?view=documents",
    label: "Документы",
  },
  {
    id: "auto_cars",
    phrases: ["автомобили", "каталог", "cars", "vehicles", "парк"],
    type: "navigate",
    route: "/workspace/auto?view=vehicles",
    label: "Автомобили",
  },
  {
    id: "auto_logistics",
    phrases: ["логистика", "в пути", "контейнер", "море"],
    type: "navigate",
    route: "/workspace/auto?view=logistics",
    label: "Логистика",
  },
  {
    id: "auto_fix_photos",
