...
export const MODULE_LANDINGS: ModuleLandingDef[] = [
  ...
  },
  {
    ...
    title: "Авто",
    purpose: "Импорт, логистика, растаможка, продажа и учёт расходов",
    description: "Закрытая операционная система нашей компании: автомобили, деньги, клиенты и документы.",
    primaryAction: { label: "Добавить автомобиль", route: "/workspace/auto?view=vehicles&action=vehicle" },
    actions: [
    ...
    stats: [
      { label: "Авто", value: "—" },
      { label: "В пути", value: "—" },
      { label: "В продаже", value: "—" },
    ],
    nextStep: "Добавьте автомобиль по VIN и ссылке на аукцион",
    aiRecommendation: "открыть парк и проверить машины без местоположения",
    aiGuide: {
      greeting: "Доброе утро.",
      bullets: ["Парк", "Логистика", "Расходы по факту"],
      recommendedAction: { label: "Открыть автомобили", route: "/workspace/auto?view=vehicles" },
    },
    estimatedMinutes: 15,
  ...
  },
  {
    ...
    primaryAction: { label: "Создать договор", route: "/workspace/legal?view=contracts" },
    actions: [
      { label: "Клиенты", route: "/workspace/legal?view=clients" },
      ...
      { label: "Сроки", route: "/workspace/legal?view=tasks" },
    ],
