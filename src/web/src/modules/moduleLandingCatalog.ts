...
export const MODULE_LANDINGS: ModuleLandingDef[] = [
  ...
  {
    id: "recruiting",
    route: "/workspace/recruiting",
    title: "Рекрутинг",
    purpose: "Лиды, кандидаты, вакансии и воронка найма",
    description: "Операционный кабинет рекрутера без выдуманных визитов.",
    primaryAction: { label: "Создать лид", route: "/workspace/recruiting?view=leads" },
    actions: [
      { label: "Лиды", route: "/workspace/recruiting?view=leads" },
      { label: "Кандидаты", route: "/workspace/recruiting?view=candidates" },
      { label: "Воронка", route: "/workspace/recruiting?view=pipeline" },
      { label: "Задачи", route: "/workspace/recruiting?view=tasks" },
      { label: "Аналитика", route: "/workspace/recruiting?view=analytics" },
    ],
    recentObjects: [{ title: "Воронка", detail: "Кандидаты в найме", route: "/workspace/recruiting?view=pipeline" }],
    recent: [{ title: "Воронка", detail: "Кандидаты в найме" }],
    stats: [
      { label: "Лиды", value: "—" },
      { label: "Кандидаты", value: "—" },
      { label: "Задачи", value: "—" },
    ],
    nextStep: "Создайте лид или откройте воронку",
    aiRecommendation: "Проверьте просроченные задачи рекрутера",
    aiGuide: {
      greeting: "Доброе утро.",
      bullets: ["Откройте входящие лиды", "Просроченные задачи на главной", "Визиты появятся после Vanguard"],
      recommendedAction: { label: "Открыть рекрутинг", route: "/workspace/recruiting" },
    },
    estimatedMinutes: 10,
    helpRoute: "/knowledge?q=recruiting",
    welcomeKey: "welcome.recruiting",
    emptyDemoRoute: "/workspace/recruiting?view=leads",
    emptyTutorialRoute: "/knowledge?view=guide&topic=recruiting",
  },
  {
    id: "knowledge",
    route: "/knowledge",
