...
const PLATFORM_MODULES: RegisteredModule[] = [
  ...
  },
  {
    ...
    purpose: "Unified pilot + production readiness + external onboarding/invites + execution.",
    version: "1.42.0",
    routes: ["/pilot", "/pilot/production", "/pilot/onboard", "/pilot/invite", "/pilot/execute"],
    permissions: ["read", "admin"],
    navigation: [
      { id: "nav_pilot", label: "Pilot Dashboard", route: "/pilot" },
      { id: "nav_production", label: "Production Readiness", route: "/pilot/production" },
      { id: "nav_onboard", label: "Onboard Organization", route: "/pilot/onboard" },
      { id: "nav_invite", label: "Invite Users", route: "/pilot/invite" },
      { id: "nav_execute", label: "Pilot Execution", route: "/pilot/execute" },
    ],
