...
export const BUILDER_CATALOG: BuilderDef[] = [
  ...
  { id: "digital_twin", name: "Enterprise Digital Twin", route: "/platform-builder/digital-twin", kind: "hub", status: "operational", purpose: "Living organization mirror — org map, heatmap, impact, timeline over existing services." },
  ...
  { id: "business_ecosystem", name: "Business Ecosystem Foundation", route: "/platform-builder/business-ecosystem", kind: "hub", status: "operational", purpose: "Reusable industry extension architecture — ecosystems extend platform core, never copy it." },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Configure CRM composition in the CRM workspace shell.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Open ERP module shell to continue composition.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Use Workflow Center for operational workflows.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Open Documents / Knowledge shell.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Manage automations in the workspace.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Customize dashboards in Workspace Dashboards.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Open Workspace Layout for templates.",
  ...
  },
  {
    ...
    steps: GENERIC_STEPS,
    frameOnly: true,
    purpose: "Preview only — Coming soon. Install packs in the Marketplace Solution Hub.",
