...
export const BUILDER_CATALOG: BuilderDef[] = [
  ...
  { id: "workflow_center", name: "Workflow Center", route: "/platform-builder/workflow-center", kind: "hub", status: "operational", purpose: "Business workflow automation templates — no new Workflow Engine." },
  { id: "enterprise_city", name: "Enterprise City", route: "/enterprise-city", kind: "hub", status: "operational", purpose: "Spatial enterprise map over existing modules." },
  ...
  { id: "integration_hub", name: "Enterprise Integration Hub", route: "/platform-builder/integrations", kind: "hub", status: "operational", purpose: "Unified control of external integrations — no new Integration Engine." },
  { id: "ai_runtime", name: "AI Runtime & Orchestration", route: "/platform-builder/runtime", kind: "hub", status: "operational", purpose: "Live AI job queue and orchestration view — no new Runtime Engine." },
  { id: "data_fabric", name: "Enterprise Data Fabric", route: "/platform-builder/data-fabric", kind: "hub", status: "operational", purpose: "Unified related data model and lineage — no new Database Engine." },
  { id: "predictive", name: "Predictive Intelligence", route: "/platform-builder/predictive", kind: "hub", status: "operational", purpose: "Forecasts and What-If scenarios — no new Prediction Engine." },
  { id: "autonomy", name: "Autonomous Enterprise", route: "/platform-builder/autonomy", kind: "hub", status: "operational", purpose: "Managed autonomy with human-in-the-loop approvals — no new Automation Engine." },
  { id: "control_tower", name: "Enterprise Control Tower", route: "/platform-builder/control-tower", kind: "hub", status: "operational", purpose: "Executive home composing Mission Control, Twin, Runtime, Predictive, Autonomy — no new Dashboard Engine." },
  { id: "self_learning", name: "Self-Learning Enterprise", route: "/platform-builder/learning", kind: "hub", status: "operational", purpose: "Continuous optimization recommendations over EI / Runtime / Workflow / Knowledge — no new Learning Engine." },
  { id: "okr_intelligence", name: "Enterprise Strategy & OKR Intelligence", route: "/platform-builder/okr", kind: "hub", status: "operational", purpose: "Company goals and OKR alignment over EI / Learning / Predictive — no new Strategy Engine." },
  { id: "governance", name: "Enterprise Governance", route: "/platform-builder/governance", kind: "hub", status: "operational", purpose: "Policies, compliance, audit, AI control over Autonomy / RBAC — no new Security Engine." },
