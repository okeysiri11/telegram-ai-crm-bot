...
MENU_CATALOG: list[MenuItem] = [
    ...
    _item("ws_settings", "Настройки", "settings", "/settings", tg="settings", group="workspace", simple=True, title_en="Settings"),
    ...
    _item("ai_studio", "AI Studio", "ai", "/ai-studio", tg="ai_studio", perms=("studio.generate",), group="ai", workspace="ai_studio"),
    ...
    _item("ai_runtime", "AI Runtime", "ai", "/platform-builder/ai-runtime", tg="ai_runtime", perms=("agent.execute",), group="ai"),
    _item("context_engine", "Context Engine", "ai", "/platform-builder/context-engine", tg="context_engine", perms=("agent.execute",), group="ai"),
    _item("project_memory", "Project Memory", "ai", "/platform-builder/project-memory", tg="project_memory", perms=("agent.execute",), group="ai"),
    _item("voice_runtime", "Voice Command Center", "ai", "/platform-builder/voice", tg="voice", perms=("agent.execute",), group="ai"),
    _item("multi_agent", "Multi-Agent Runtime", "ai", "/platform-builder/multi-agent", tg="multi_agent", perms=("agent.execute",), group="ai"),
    _item("skills_sdk", "AI Skills & SDK", "ai", "/platform-builder/skills", tg="skills", perms=("agent.execute",), group="ai"),
    _item("creative_factory", "Creative Factory", "ai", "/platform-builder/creative", tg="creative", perms=("agent.execute",), group="ai"),
    _item("enterprise_city_runtime", "Enterprise City Runtime", "analytics", "/platform", tg="platform", perms=("agent.execute",), group="platform"),
    _item("ai_team", "AI Team", "ai", "/platform-builder/ai-team", tg="ai_team", perms=("agent.execute",), group="ai"),
    # City
    _item("city_map", "Enterprise City", "city", "/enterprise-city", tg="city", group="city", title_en="Enterprise City"),
    _item("city_control", "Control Tower", "city", "/control-tower", tg="control_tower", group="city", roles=("owner", "administrator", "ceo")),
    # Platform
    _item("plat_builder", "Platform Builder", "builder", "/platform-builder", tg="platform_builder", perms=("platform.config.read",), group="platform", roles=("owner", "administrator", "ceo")),
    _item("plat_service_builder", "Service Builder", "builder", "/platform-builder/service-builder", tg="service_builder", perms=("platform.config.read",), group="platform", roles=("owner", "administrator", "ceo")),
    _item("plat_event_bus", "Event Bus", "zap", "/platform-builder/event-bus", tg="event_bus", perms=("platform.config.read",), group="platform", roles=("owner", "administrator", "ceo")),
    _item("plat_workflows", "Workflows", "workflow", "/platform-builder/workflows", tg="workflows", perms=("platform.config.read",), group="platform", roles=("owner", "administrator", "ceo")),
