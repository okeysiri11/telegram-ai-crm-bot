...
VERTICAL_REGISTRY: dict[str, VerticalDef] = {
    ...
    "cafe_beauty": VerticalDef(
        ...
        title="Cafe",
        icon="cafe",
        description="Hospitality / cafe operations",
    ...
    "beauty": VerticalDef(
        ...
        title="Beauty",
        icon="beauty",
        description="Salon: appointments, calendar, services, clients",
        workspace="beauty",
        default_roles=("owner", "manager", "specialist", "client"),
        enabled_modules=("crm", "calendar", "tasks"),
        enabled_agents=("agent_beauty",),
        enabled_features=("booking", "loyalty"),
        web_path="/workspace/beauty",
        telegram_entry="beauty",
    ),
    "legal": VerticalDef(
        id="legal",
        title="Legal",
