...
def register_recruiting_enterprise_routes(app: web.Application) -> None:
    ...
    app.router.add_get(f"{ops}/providers/{{provider}}/accounts", ops_handlers.ops_provider_accounts_handler)
    app.router.add_get(f"{ops}/providers/{{provider}}/diagnostics", ops_handlers.ops_provider_diagnostics_get_handler)
    app.router.add_post(f"{ops}/providers/{{provider}}/select-account", ops_handlers.ops_provider_select_account_handler)
    app.router.add_post(f"{ops}/providers/mappings", ops_handlers.ops_provider_mapping_handler)
    ...
    app.router.add_post(f"{ops}/candidates/{{candidate_id}}/assign", ops_handlers.ops_candidate_assign_handler)
    app.router.add_post(f"{ops}/candidates/{{candidate_id}}/interview", ops_handlers.ops_candidate_interview_handler)
    ...
    app.router.add_get(f"{ops}/campaigns/{{campaign_id}}", ops_handlers.ops_campaign_detail_handler)
    app.router.add_post(f"{ops}/campaigns/{{campaign_id}}", ops_handlers.ops_campaign_update_handler)
    app.router.add_post(f"{ops}/campaigns/{{campaign_id}}/spend", ops_handlers.ops_campaign_spend_handler)
