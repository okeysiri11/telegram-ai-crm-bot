...
def register_platform_builder_routes(app: web.Application) -> None:
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/catalog",
        handlers.twin_intelligence_catalog_handler,
    )
    app.router.add_get(
        f"{prefix}/twin-intelligence/status",
        handlers.twin_intelligence_status_handler,
    )
    app.router.add_get(
        f"{prefix}/twin-intelligence/engine",
        handlers.twin_intelligence_engine_handler,
    )
    app.router.add_get(
        f"{prefix}/twin-intelligence/scenarios",
        handlers.twin_intelligence_scenarios_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/scenarios",
        handlers.twin_intelligence_scenarios_handler,
    ...
    app.router.add_get(
        ...
        handlers.twin_intelligence_what_if_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/what-if",
        handlers.twin_intelligence_what_if_handler,
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/impact",
        handlers.twin_intelligence_impact_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/impact",
        handlers.twin_intelligence_impact_handler,
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/risk",
        handlers.twin_intelligence_risk_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/risk",
        handlers.twin_intelligence_risk_handler,
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/capacity",
        handlers.twin_intelligence_capacity_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/capacity",
        handlers.twin_intelligence_capacity_handler,
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/recommendations",
        handlers.twin_intelligence_recommendations_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/recommendations",
        handlers.twin_intelligence_recommendations_handler,
    ...
    app.router.add_get(
        ...
        handlers.twin_intelligence_comparison_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/comparison",
        handlers.twin_intelligence_comparison_handler,
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/performance",
        handlers.twin_intelligence_performance_handler,
    )
    app.router.add_post(
        f"{prefix}/twin-intelligence/performance",
        handlers.twin_intelligence_performance_handler,
    )
    app.router.add_get(f"{prefix}/twin-intelligence/ui", handlers.twin_intelligence_ui_handler)
    app.router.add_post(
        f"{prefix}/twin-intelligence/sessions",
        handlers.twin_intelligence_wizard_session_handler,
    )
    app.router.add_get(
        f"{prefix}/twin-intelligence/sessions/{{session_id}}",
        handlers.twin_intelligence_wizard_session_handler,
    )
    app.router.add_patch(
        f"{prefix}/twin-intelligence/sessions/{{session_id}}",
    ...
    app.router.add_get(
        f"{prefix}/twin-intelligence/sessions/{{session_id}}/summary",
        handlers.twin_intelligence_wizard_summary_handler,
    )
    app.router.add_post(
    ...
    app.router.add_get(
        f"{prefix}/mission-control/catalog",
        handlers.mission_control_catalog_handler,
    )
    app.router.add_get(
        f"{prefix}/mission-control/status",
        handlers.mission_control_status_handler,
    )
    app.router.add_get(
        f"{prefix}/mission-control/engine",
        handlers.mission_control_engine_handler,
    )
    app.router.add_get(
        f"{prefix}/mission-control/operations",
        handlers.mission_control_operations_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/operations",
        handlers.mission_control_operations_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/overview",
        handlers.mission_control_overview_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/overview",
        handlers.mission_control_overview_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/activity",
        handlers.mission_control_activity_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/activity",
        handlers.mission_control_activity_handler,
    ...
    app.router.add_get(
        ...
        handlers.mission_control_panels_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/panels",
        handlers.mission_control_panels_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/decisions",
        handlers.mission_control_decisions_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/decisions",
        handlers.mission_control_decisions_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/resources",
        handlers.mission_control_resources_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/resources",
        handlers.mission_control_resources_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/timeline",
        handlers.mission_control_timeline_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/timeline",
        handlers.mission_control_timeline_handler,
    ...
    app.router.add_get(
        f"{prefix}/mission-control/performance",
        handlers.mission_control_performance_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/performance",
        handlers.mission_control_performance_handler,
    )
    app.router.add_get(f"{prefix}/mission-control/ui", handlers.mission_control_ui_handler)
    app.router.add_post(
        f"{prefix}/mission-control/sessions",
        handlers.mission_control_wizard_session_handler,
    )
    app.router.add_get(
        f"{prefix}/mission-control/sessions/{{session_id}}",
        handlers.mission_control_wizard_session_handler,
    )
    app.router.add_patch(
        f"{prefix}/mission-control/sessions/{{session_id}}",
    ...
    app.router.add_get(
        f"{prefix}/mission-control/sessions/{{session_id}}/summary",
        handlers.mission_control_wizard_summary_handler,
    )
    app.router.add_post(
        f"{prefix}/mission-control/sessions/{{session_id}}/create",
        handlers.mission_control_create_handler,
    )

    # Sprint 30.2 — Business Ecosystem Foundation
    app.router.add_get(
        f"{prefix}/business-ecosystem/catalog",
        handlers.business_ecosystem_catalog_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/status",
        handlers.business_ecosystem_status_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/framework",
        handlers.business_ecosystem_framework_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/modules",
        handlers.business_ecosystem_modules_handler,
    )
    app.router.add_post(
        f"{prefix}/business-ecosystem/modules",
        handlers.business_ecosystem_modules_handler,
    ...
    app.router.add_get(
        f"{prefix}/business-ecosystem/extensions",
        handlers.business_ecosystem_extensions_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/registry",
        handlers.business_ecosystem_registry_handler,
    )
    app.router.add_post(
        f"{prefix}/business-ecosystem/registry",
        handlers.business_ecosystem_registry_handler,
    ...
    app.router.add_get(
        f"{prefix}/business-ecosystem/automotive",
        handlers.business_ecosystem_automotive_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/agriculture",
        handlers.business_ecosystem_agriculture_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/beauty-cafe",
        handlers.business_ecosystem_beauty_cafe_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/crypto-legal-drone",
        handlers.business_ecosystem_crypto_legal_drone_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/compatibility",
        handlers.business_ecosystem_compatibility_handler,
    )
    app.router.add_post(
        f"{prefix}/business-ecosystem/compatibility",
        handlers.business_ecosystem_compatibility_handler,
    )
    app.router.add_get(f"{prefix}/business-ecosystem/ui", handlers.business_ecosystem_ui_handler)
    app.router.add_post(
        f"{prefix}/business-ecosystem/sessions",
        handlers.business_ecosystem_wizard_session_handler,
    )
    app.router.add_get(
        f"{prefix}/business-ecosystem/sessions/{{session_id}}",
        handlers.business_ecosystem_wizard_session_handler,
    )
    app.router.add_patch(
        f"{prefix}/business-ecosystem/sessions/{{session_id}}",
    ...
    app.router.add_get(
        f"{prefix}/business-ecosystem/sessions/{{session_id}}/summary",
        handlers.business_ecosystem_wizard_summary_handler,
    )
    app.router.add_post(
        f"{prefix}/business-ecosystem/sessions/{{session_id}}/create",
        handlers.business_ecosystem_create_handler,
    )
