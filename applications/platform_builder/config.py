"""Platform Builder — Sprint 1.1.1 Enterprise Platform v1.1 General Availability."""
...
class PlatformBuilderConfig:
    ...
    application_version: str = "1.67.0"
    sprint: str = "1.1.1"
    release_status: str = "Enterprise Platform v1.1 General Availability"
