"""Platform Builder — Sprint 34.0 Enterprise Platform v1.0 Release Candidate."""
...
class PlatformBuilderConfig:
    ...
    application_version: str = "1.66.0"
    sprint: str = "34.0"
    release_status: str = "Enterprise Platform v1.0 Release Candidate"
