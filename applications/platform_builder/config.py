"""Platform Builder — Sprint 32.3.1 First User Experience (Platform Entry)."""
...
class PlatformBuilderConfig:
    ...
    application_version: str = "1.43.0"
    sprint: str = "32.3.1"
    release_status: str = "First User Experience (Platform Entry)"
