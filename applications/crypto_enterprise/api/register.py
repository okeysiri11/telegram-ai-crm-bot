...
def register_crypto_enterprise_routes(app: web.Application) -> None:
    ...
    # Sprint 50.0 — EUR/USD + DXY market intelligence (canonical Web/Telegram path)
    from applications.crypto_enterprise.api import fx_intel_handlers as fxh

    fx = f"{mi}/fx-intel"
    app.router.add_get(f"{fx}/health", fxh.fx_intel_health_handler)
    app.router.add_get(f"{fx}/snapshot", fxh.fx_intel_snapshot_handler)
    app.router.add_get(f"{fx}/quote", fxh.fx_intel_quote_handler)
    app.router.add_post(f"{fx}/quote", fxh.fx_intel_quote_handler)
    app.router.add_post(f"{fx}/run", fxh.fx_intel_run_handler)
    app.router.add_get(f"{fx}/signals", fxh.fx_intel_signals_handler)
    app.router.add_get(f"{fx}/news", fxh.fx_intel_news_handler)
    app.router.add_post(f"{fx}/news", fxh.fx_intel_news_handler)
    app.router.add_get(f"{fx}/macro", fxh.fx_intel_macro_handler)
    app.router.add_get(f"{fx}/memory", fxh.fx_intel_memory_handler)
    app.router.add_post(f"{fx}/technical", fxh.fx_intel_technical_handler)
    app.router.add_post(f"{fx}/correlation", fxh.fx_intel_correlation_handler)
    app.router.add_get(f"{fx}/candles", fxh.fx_intel_candles_handler)
    app.router.add_post(f"{fx}/candles", fxh.fx_intel_candles_handler)
    app.router.add_get(f"{fx}/history", fxh.fx_intel_history_handler)
    app.router.add_get(f"{fx}/history/{{run_id}}", fxh.fx_intel_history_handler)
    app.router.add_get(f"{fx}/paper", fxh.fx_intel_paper_handler)
    app.router.add_post(f"{fx}/paper", fxh.fx_intel_paper_handler)
    app.router.add_get(f"{fx}/journal", fxh.fx_intel_journal_handler)
    app.router.add_post(f"{fx}/signals", fxh.fx_intel_signal_create_handler)
    app.router.add_get(f"{fx}/links", fxh.fx_intel_links_handler)
    app.router.add_get(f"{fx}/notifications", fxh.fx_intel_notifications_handler)
    app.router.add_get(f"{fx}/schedule", fxh.fx_intel_schedule_handler)
    app.router.add_post(f"{fx}/schedule", fxh.fx_intel_schedule_handler)
    app.router.add_post(f"{fx}/signals/lifecycle", fxh.fx_intel_signal_patch_handler)
    app.router.add_post(f"{fx}/notifications", fxh.fx_intel_notifications_handler)
    app.router.add_get(f"{fx}/calendar", fxh.fx_intel_calendar_handler)
    app.router.add_post(f"{fx}/calendar", fxh.fx_intel_calendar_handler)
