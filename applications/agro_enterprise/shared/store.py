...
class AgroEnterpriseStore:
    def __init__(self) -> None:
        ...
        # Sprint 14.5 — Supply Chain / Elevators / Warehouses / Export
        self.sc_nodes: EntityStore = EntityStore()
        self.sc_dcs: EntityStore = EntityStore()
        self.sc_shipments: EntityStore = EntityStore()
        self.sc_supply_plans: EntityStore = EntityStore()
        self.sc_demand_plans: EntityStore = EntityStore()
        self.sc_orders: EntityStore = EntityStore()
        self.sc_elevators: EntityStore = EntityStore()
        self.sc_silos: EntityStore = EntityStore()
        self.sc_intake: EntityStore = EntityStore()
        self.sc_dispatch: EntityStore = EntityStore()
        self.sc_drying: EntityStore = EntityStore()
        self.sc_cleaning: EntityStore = EntityStore()
        self.sc_quality: EntityStore = EntityStore()
        self.sc_certificates: EntityStore = EntityStore()
        self.sc_warehouses: EntityStore = EntityStore()
        self.sc_inventory: EntityStore = EntityStore()
        self.sc_wh_opts: EntityStore = EntityStore()
        self.sc_plants: EntityStore = EntityStore()
        self.sc_processing: EntityStore = EntityStore()
        self.sc_prod_plans: EntityStore = EntityStore()
        self.sc_trucks: EntityStore = EntityStore()
        self.sc_rail: EntityStore = EntityStore()
        self.sc_containers: EntityStore = EntityStore()
        self.sc_routes: EntityStore = EntityStore()
        self.sc_freight: EntityStore = EntityStore()
        self.sc_cargo: EntityStore = EntityStore()
        self.sc_deliveries: EntityStore = EntityStore()
        self.sc_export_contracts: EntityStore = EntityStore()
        self.sc_intl_buyers: EntityStore = EntityStore()
        self.sc_pricing: EntityStore = EntityStore()
        self.sc_export_docs: EntityStore = EntityStore()
        self.sc_desk_orders: EntityStore = EntityStore()
        self.sc_dashboards: EntityStore = EntityStore()
        self.sc_registries: EntityStore = EntityStore()
        # Sprint 14.6 — Agro Finance / Exchange / Risk / Insurance
        self.af_commodities: EntityStore = EntityStore()
        self.af_orders: EntityStore = EntityStore()
        self.af_trades: EntityStore = EntityStore()
        self.af_contracts: EntityStore = EntityStore()
        self.af_vault: EntityStore = EntityStore()
        self.af_budgets: EntityStore = EntityStore()
        self.af_cashflows: EntityStore = EntityStore()
        self.af_costs: EntityStore = EntityStore()
        self.af_credit: EntityStore = EntityStore()
        self.af_loans: EntityStore = EntityStore()
        self.af_subsidies: EntityStore = EntityStore()
        self.af_grants: EntityStore = EntityStore()
        self.af_insurers: EntityStore = EntityStore()
        self.af_policies: EntityStore = EntityStore()
        self.af_coverage: EntityStore = EntityStore()
        self.af_ins_risk: EntityStore = EntityStore()
        self.af_claims: EntityStore = EntityStore()
        self.af_risks: EntityStore = EntityStore()
        self.af_warnings: EntityStore = EntityStore()
        self.af_prices: EntityStore = EntityStore()
        self.af_trends: EntityStore = EntityStore()
        self.af_supply_demand: EntityStore = EntityStore()
        self.af_forecasts: EntityStore = EntityStore()
        self.af_export_analytics: EntityStore = EntityStore()
