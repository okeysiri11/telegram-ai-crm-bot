# Agro Enterprise Platform — Sprint 14.2 Smart Irrigation.
...
class AgroEnterpriseConfig:
    ...
    application_version: str = "4.3.2-enterprise"
    release_status: str = "Smart Irrigation"
    platform_dependency: str = "AI Platform Core v3"
    enterprise_foundation: str = "Enterprise Platform v4.3.1-enterprise"
