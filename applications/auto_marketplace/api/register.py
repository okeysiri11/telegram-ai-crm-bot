...
def register_auto_marketplace_routes(app: web.Application) -> None:
    ...
    app.router.add_get(f"{crm}/execution", crm_handlers.crm_execution_summary_handler)
    app.router.add_get(f"{crm}/execution/queue", crm_handlers.crm_execution_queue_handler)
    app.router.add_get(f"{crm}/manager/command-center", crm_handlers.crm_manager_command_center_handler)
    ...
    app.router.add_patch(f"{crm}/leads/{{lead_id}}", crm_handlers.update_lead_handler)
    app.router.add_delete(f"{crm}/leads/{{lead_id}}", crm_handlers.delete_lead_handler)
    ...
    app.router.add_get(f"{crm}/leads/{{lead_id}}/execution", crm_handlers.lead_sales_execution_handler)
    ...
    app.router.add_get(f"{crm}/deals/{{deal_id}}/execution", crm_handlers.deal_sales_execution_handler)
    ...
    app.router.add_get(f"{crm}/calls", crm_handlers.list_calls_handler)
    app.router.add_get(f"{crm}/calls/{{call_id}}", crm_handlers.get_call_handler)
    app.router.add_patch(f"{crm}/calls/{{call_id}}", crm_handlers.update_call_handler)
    app.router.add_delete(f"{crm}/calls/{{call_id}}", crm_handlers.delete_call_handler)
    app.router.add_get(f"{crm}/emails", crm_handlers.list_emails_handler)
    app.router.add_get(f"{crm}/emails/{{email_id}}", crm_handlers.get_email_handler)
    app.router.add_patch(f"{crm}/emails/{{email_id}}", crm_handlers.update_email_handler)
    app.router.add_delete(f"{crm}/emails/{{email_id}}", crm_handlers.delete_email_handler)
    app.router.add_get(f"{crm}/calendar/meetings", crm_handlers.list_meetings_handler)
    app.router.add_post(f"{crm}/calendar/meetings", crm_handlers.schedule_meeting_handler)
    app.router.add_get(f"{crm}/calendar/meetings/{{meeting_id}}", crm_handlers.get_meeting_handler)
    app.router.add_patch(f"{crm}/calendar/meetings/{{meeting_id}}", crm_handlers.update_meeting_handler)
    app.router.add_delete(f"{crm}/calendar/meetings/{{meeting_id}}", crm_handlers.delete_meeting_handler)
    app.router.add_post(f"{crm}/calendar/meetings/{{meeting_id}}/cancel", crm_handlers.cancel_meeting_handler)
    app.router.add_get(f"{crm}/reminders", crm_handlers.list_reminders_handler)
    app.router.add_post(f"{crm}/reminders", crm_handlers.create_reminder_handler)
    app.router.add_get(f"{crm}/reminders/{{reminder_id}}", crm_handlers.get_reminder_handler)
    app.router.add_patch(f"{crm}/reminders/{{reminder_id}}", crm_handlers.update_reminder_handler)
    app.router.add_delete(f"{crm}/reminders/{{reminder_id}}", crm_handlers.delete_reminder_handler)
    app.router.add_post(f"{crm}/reminders/{{reminder_id}}/complete", crm_handlers.complete_reminder_handler)
    app.router.add_post(f"{crm}/reminders/{{reminder_id}}/dismiss", crm_handlers.dismiss_reminder_handler)
