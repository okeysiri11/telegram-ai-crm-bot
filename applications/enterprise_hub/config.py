"""Enterprise Hub — Sprint 21.8 Enterprise Release Candidate & Production Readiness (Enterprise Core v6.0 LTS)."""
...
class EnterpriseHubConfig:
    ...
    application_version: str = "6.0.0"
    release_status: str = "Enterprise Core v6.0 LTS"
    platform_dependency: str = "AI Platform Core v3"
    enterprise_foundation: str = "Enterprise Platform v6.0.0-rc7"
