...
def register_enterprise_hub_routes(app: web.Application) -> None:
    ...
    app.router.add_get(f"{bos}/employees", bos_api.bos_employee_handler)
    app.router.add_post(f"{bos}/employees", bos_api.bos_employee_handler)
    app.router.add_get(f"{bos}/services", bos_api.bos_service_handler)
    app.router.add_post(f"{bos}/services", bos_api.bos_service_handler)
    app.router.add_get(f"{bos}/customers", bos_api.bos_customer_handler)
    app.router.add_post(f"{bos}/customers", bos_api.bos_customer_handler)
    app.router.add_get(f"{bos}/appointments", bos_api.bos_appointment_handler)
    app.router.add_post(f"{bos}/appointments", bos_api.bos_appointment_handler)
    app.router.add_get(f"{bos}/branches", bos_api.bos_branches_list_handler)
    ...
    app.router.add_get(f"{cos}/staff", cos_api.cos_staff_handler)
    app.router.add_post(f"{cos}/staff", cos_api.cos_staff_handler)
    app.router.add_get(f"{cos}/customers", cos_api.cos_customers_handler)
    app.router.add_post(f"{cos}/customers", cos_api.cos_customers_handler)
    app.router.add_get(f"{cos}/reservations", cos_api.cos_reservations_handler)
    app.router.add_post(f"{cos}/reservations", cos_api.cos_reservations_handler)
    app.router.add_get(f"{cos}/orders", cos_api.cos_orders_handler)
    app.router.add_post(f"{cos}/orders", cos_api.cos_orders_handler)
    app.router.add_get(f"{cos}/shifts", cos_api.cos_shifts_handler)
    app.router.add_post(f"{cos}/shifts", cos_api.cos_shifts_handler)
