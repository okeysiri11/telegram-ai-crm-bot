...
class AIWorkspace:
    ...
    def create(self, *, tenant_id: str, name: str = "AI Workspace", **settings: Any) -> dict[str, Any]:
        return self.workspaces.create(
            tenant_id=tenant_id, name=name, kind=self.kind, settings=settings or {"modules": ["agents", "memory"]}
        )
