...
class CRMWorkspace:
    ...
    def create(self, *, tenant_id: str, name: str = "CRM Workspace", **settings: Any) -> dict[str, Any]:
        return self.workspaces.create(
            tenant_id=tenant_id, name=name, kind=self.kind, settings=settings or {"modules": ["leads", "deals"]}
        )
