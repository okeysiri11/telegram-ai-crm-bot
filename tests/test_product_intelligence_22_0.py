"""Tests — Enterprise Product Intelligence (Sprint 22.0 / v6.3.0)."""
...
def test_version_epi_ready():
    ...
    assert health["application_version"] == "6.3.0"
    assert health["enterprise_foundation"] == "Enterprise Platform v6.2.0"
...
async def test_api_epi(client):
    ...
    assert body["application_version"] == "6.3.0"
...
def test_docs_and_regression_22_0():
    ...
    assert '"application_version": "6.3.0"' in manifest
    assert "22.2" in manifest
