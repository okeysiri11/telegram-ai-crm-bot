...
def test_version_finance_enterprise_ready():
    ...
    assert health["application_version"] == "5.1.0-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v5.0.0-enterprise"
...
def test_ledger_and_knowledge():
    ...
    assert boot["version"] == "5.1.0-enterprise"
...
async def test_api_finance_enterprise(client):
    ...
    assert body["application_version"] == "5.1.0-enterprise"
...
def test_docs_and_regression_18_0():
    ...
    assert "5.1.0-enterprise" in manifest
    assert "18.0" in manifest
