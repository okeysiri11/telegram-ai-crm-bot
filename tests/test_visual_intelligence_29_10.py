"""Tests — Visual Intelligence Engine (Sprint 29.10)."""
...
async def test_api_intelligence(client):
    ...
    assert body["application_version"] == "1.17.0"
    ...
    assert '"application_version": "1.17.0"' in manifest
    assert "29.10" in manifest
