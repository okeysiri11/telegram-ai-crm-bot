"""Tests — Visual Intelligence Engine (Sprint 29.12)."""
...
async def test_api_intelligence(client):
    ...
    assert body["application_version"] == "1.19.0"
    ...
    assert '"application_version": "1.19.0"' in manifest
    assert "29.12" in manifest
