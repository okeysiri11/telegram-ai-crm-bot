...
def test_operations_center_ready():
    ...
    assert health["application_version"] == "1.11.0"
    assert health["sprint"] == "29.4"
...
async def test_api_operations_center(client):
    ...
    assert body["application_version"] == "1.11.0"
...
def test_docs_operations_center_29_1():
    ...
    assert '"application_version": "1.11.0"' in manifest
    assert "29.4" in manifest
