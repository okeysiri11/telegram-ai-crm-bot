"""Tests — Enterprise Operations Center & Pilot Release (Sprint 25.2 / v8.2.0)."""
...
def test_dashboard_health_feedback_owner():
    ...
    rel = suite.record_release(version="8.2.0", changelog=["eoc"], test_results={"passed": True})
    assert rel["version"] == "8.2.0"
