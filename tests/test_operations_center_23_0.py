"""Tests — Enterprise Operations Center & Pilot Release (Sprint 25.5 / v8.5.0)."""
...
def test_dashboard_health_feedback_owner():
    ...
    rel = suite.record_release(version="8.5.0", changelog=["eoc"], test_results={"passed": True})
    assert rel["version"] == "8.5.0"
