"""Tests — Enterprise Operations Center & Pilot Release (Sprint 23.0 / v6.11.0)."""
...
def test_dashboard_health_feedback_owner():
    ...
    rel = suite.record_release(version="6.11.0", changelog=["eoc"], test_results={"passed": True})
    assert rel["version"] == "6.11.0"
