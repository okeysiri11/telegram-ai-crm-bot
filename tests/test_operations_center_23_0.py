"""Tests — Enterprise Operations Center & Pilot Release (Sprint 24.1 / v7.1.0)."""
...
def test_dashboard_health_feedback_owner():
    ...
    rel = suite.record_release(version="7.1.0", changelog=["eoc"], test_results={"passed": True})
    assert rel["version"] == "7.1.0"
