"""Tests — Enterprise Operations Center & Pilot Release (Sprint 24.8 / v7.8.0)."""
...
def test_dashboard_health_feedback_owner():
    ...
    rel = suite.record_release(version="7.8.0", changelog=["eoc"], test_results={"passed": True})
    assert rel["version"] == "7.8.0"
