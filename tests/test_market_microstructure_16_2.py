...
def test_version_market_microstructure_ready():
    ...
    assert health["application_version"] == "4.7.2-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.7.1-enterprise"
...
def test_ai_market_and_bootstrap():
    ...
    assert boot["version"] == "4.7.2-enterprise"
...
async def test_api_market_microstructure(client):
    ...
    assert body["application_version"] == "4.7.2-enterprise"
    ...
    assert (await ce.json())["application_version"] == "4.7.2-enterprise"
...
def test_docs_and_regression_16_2():
    ...
    assert "4.7.2-enterprise" in manifest
    assert "16.2" in manifest
