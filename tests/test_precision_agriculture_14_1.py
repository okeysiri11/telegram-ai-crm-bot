...
def test_version_precision_ready():
    ...
    assert health["application_version"] == "4.3.2-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.3.1-enterprise"
...
async def test_api_precision_agriculture(client):
    ...
    assert body["application_version"] == "4.3.2-enterprise"
...
def test_docs_and_regression_14_1():
    ...
    assert "4.3.2-enterprise" in manifest
    assert "14.2" in manifest
