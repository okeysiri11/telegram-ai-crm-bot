"""Tests — God Mode Expansion (Sprint 29.1)."""
...
def test_control_center_owner_gate_and_flow():
    ...
    edited = cc.edit("platform_owner", oid, {"metadata": {"note": "sprint-29.1"}, "properties": {"x": 1}})
...
def test_docs_god_mode_28_7():
    ...
    assert '"application_version": "1.8.0"' in manifest
    assert "29.1" in manifest
