...
def test_version_legislation_intelligence_ready():
    ...
    assert health["application_version"] == "4.9.1-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.9.0-enterprise"
...
def test_search_analysis_and_bootstrap():
    ...
    assert boot["version"] == "4.9.1-enterprise"
...
async def test_api_legislation_intelligence(client):
    ...
    assert body["application_version"] == "4.9.1-enterprise"
    ...
    assert (await ce.json())["application_version"] == "4.9.1-enterprise"
...
def test_docs_and_regression_17_1():
    ...
    assert "4.9.1-enterprise" in manifest
    assert "17.1" in manifest
