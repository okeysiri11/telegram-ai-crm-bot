...
def test_version_orchestrator_ready():
    ...
    assert health["application_version"] == "5.4.9-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v5.4.8-enterprise"
...
async def test_api_orchestrator(client):
    ...
    assert (await hub.json())["application_version"] == "5.4.9-enterprise"
