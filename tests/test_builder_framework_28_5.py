"""Tests — Universal Builder Framework (Sprint 28.5)."""
...
def test_ubf_ready_catalog_and_lifecycle():
    ...
    assert health["application_version"] == "1.4.0"
    assert health["sprint"] == "28.5"
...
async def test_api_ubf(client):
    ...
    assert body["application_version"] == "1.4.0"
...
def test_docs_and_frontend_28_5():
    ...
    assert '"application_version": "1.4.0"' in manifest
    assert "28.5" in manifest
