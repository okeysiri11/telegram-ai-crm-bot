...
def test_version_crypto_enterprise_ready():
    ...
    assert health["application_version"] == "4.7.0-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.6.0-enterprise"
...
async def test_api_crypto_enterprise(client):
    ...
    assert body["application_version"] == "4.7.0-enterprise"
...
def test_docs_and_regression_16_0():
    ...
    assert "4.7.0-enterprise" in manifest
    assert "16.0" in manifest
