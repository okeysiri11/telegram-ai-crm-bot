...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("PATCH", "/api/auto/v1/crm/leads/lead-x", {"notes": "n"}),
        ("PATCH", "/api/auto/v1/crm/customers/cust-x", {"first_name": "B"}),
        ("PATCH", "/api/auto/v1/crm/deals/deal-x", {"amount": 1}),
        ("DELETE", "/api/auto/v1/crm/leads/lead-x", {}),
        ("POST", "/api/auto/v1/crm/tasks", {"title": "t"}),
        ("PATCH", "/api/auto/v1/crm/tasks/task-x", {"title": "u"}),
        ("DELETE", "/api/auto/v1/crm/tasks/task-x", {}),
        ("POST", "/api/auto/v1/crm/tasks/task-x/complete", {}),
        ("POST", "/api/auto/v1/crm/tasks/task-x/reopen", {}),
        ("POST", "/api/auto/v1/crm/activities", {"subject": "n", "activity_type": "note"}),
        ...
        ("PATCH", "/api/auto/v1/crm/calls/call-x", {"status": "completed"}),
        ("POST", "/api/auto/v1/crm/reminders", {"message": "ping"}),
        ("POST", "/api/auto/v1/crm/activities/emails", {"customer_id": "c1"}),
        ("POST", "/api/auto/v1/crm/calendar/meetings", {"title": "m"}),
