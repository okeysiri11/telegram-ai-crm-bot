"""Tests — Enterprise Vertical Builder (Sprint 28.4)."""
...
def test_vertical_ready_and_catalog():
    ...
    assert health["application_version"] == "1.3.0"
    assert health["sprint"] == "28.4"
...
async def test_api_vertical(client):
    ...
    assert body["application_version"] == "1.3.0"
...
def test_docs_and_frontend_28_4():
    ...
    assert '"application_version": "1.3.0"' in manifest
    assert "28.4" in manifest
