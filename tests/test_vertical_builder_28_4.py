"""Tests — Enterprise Vertical Builder (Sprint 28.6)."""
...
def test_vertical_ready_and_catalog():
    ...
    assert health["application_version"] == "1.5.0"
    assert health["sprint"] == "28.6"
...
def test_docs_and_frontend_28_4():
    ...
    assert '"application_version": "1.5.0"' in manifest
    assert "28.6" in manifest
