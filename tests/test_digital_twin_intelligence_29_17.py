"""Tests — Digital Twin Intelligence Engine (Sprint 29.17)."""
...
def test_digital_twin_intelligence_ready():
    ...
    assert health["application_version"] == "1.24.0"
    assert health["sprint"] == "29.17"
...
async def test_api_digital_twin_intelligence(client):
    ...
    assert body["application_version"] == "1.24.0"
    ...
    assert '"application_version": "1.24.0"' in manifest
    assert "29.17" in manifest
