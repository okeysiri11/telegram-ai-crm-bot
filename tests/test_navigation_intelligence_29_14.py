"""Tests — Navigation Intelligence Engine (Sprint 29.16)."""
...
def test_navigation_intelligence_ready():
    ...
    assert health["application_version"] == "1.23.0"
    assert health["sprint"] == "29.16"
...
async def test_api_navigation_intelligence(client):
    ...
    assert body["application_version"] == "1.23.0"
    ...
    assert '"application_version": "1.23.0"' in manifest
    assert "29.16" in manifest
