"""Tests — Navigation Intelligence Engine (Sprint 29.15)."""
...
async def test_api_navigation_intelligence(client):
    ...
    assert body["application_version"] == "1.22.0"
    ...
    assert '"application_version": "1.22.0"' in manifest
    assert "29.15" in manifest
