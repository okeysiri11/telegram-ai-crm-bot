...
def test_collaborative_ai_ready():
    ...
    assert health["application_version"] == "1.12.0"
    assert health["sprint"] == "29.5"
...
async def test_api_collaborative_ai(client):
    ...
    assert body["application_version"] == "1.12.0"
...
def test_docs_collaborative_ai_28_8():
    ...
    assert '"application_version": "1.12.0"' in manifest
    assert "29.5" in manifest
