...
def test_platform_bidex_version():
    ...
    assert health["release_status"] == "External Pilot Hardening & Tenant Onboarding"
...
def test_reuse_docs_and_manifest():
    ...
    assert "External Pilot Hardening & Tenant Onboarding" in manifest
