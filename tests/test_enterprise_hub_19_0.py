...
def test_version_hub_foundation_ready():
    ...
    assert health["application_version"] == "5.3.0-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v5.2.0-enterprise"
...
def test_event_bus_bootstrap():
    ...
    assert boot["version"] == "5.3.0-enterprise"
...
async def test_api_enterprise_hub(client):
    ...
    assert body["application_version"] == "5.3.0-enterprise"
...
def test_docs_and_regression_19_0():
    ...
    assert "5.3.0-enterprise" in manifest
