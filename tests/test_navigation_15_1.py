...
def test_version_navigation_ready():
    ...
    assert health["application_version"] == "4.5.1-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.5.0-enterprise"
...
async def test_api_navigation(client):
    ...
    assert body["application_version"] == "4.5.1-enterprise"
...
def test_docs_and_regression_15_1():
    ...
    assert "4.5.1-enterprise" in manifest
    assert "15.1" in manifest
