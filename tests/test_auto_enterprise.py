...
def test_version_modules_docs_bridges():
    ...
    for doc in ("AUTO_ENTERPRISE.md", "AUTO_RELEASE.md", "AUTO_MARKETPLACE.md"):
        ...
        assert "4.1.7-enterprise" in text
...
def test_production_validation_and_release():
    ...
    assert report.application_version == "4.1.7-enterprise"
    ...
    pre = auto_marketplace.enterprise.deployment.preflight(version="4.1.7-enterprise")
