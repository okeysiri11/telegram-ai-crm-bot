...
def test_version_auto_marketplace_ready():
    ...
    assert health["enterprise_foundation"] == "Enterprise Platform v4.1.1-enterprise"
...
async def test_api_auto_marketplace(client):
    ...
    assert legacy_body["application_version"] == "4.1.2-enterprise"
...
def test_docs_and_regression_13_0():
    ...
    assert "4.1.2-enterprise" in manifest
    assert "13.2" in manifest
