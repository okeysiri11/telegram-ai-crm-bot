...
def test_version_auto_marketplace_ready():
    ...
    assert health["application_version"] == "4.1.3-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.1.2-enterprise"
...
def test_docs_and_regression_13_0():
    ...
    assert "4.1.3-enterprise" in manifest
    assert "13.3" in manifest
