...
def test_version_agro_enterprise_ready():
    ...
    assert health["application_version"] == "4.3.1-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.3.0-enterprise"
...
async def test_api_agro_enterprise(client):
    ...
    assert body["application_version"] == "4.3.1-enterprise"
...
def test_docs_and_regression_14_0():
    ...
    assert "4.3.1-enterprise" in manifest
    assert "14.1" in manifest
