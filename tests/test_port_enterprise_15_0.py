...
def test_version_port_enterprise_ready():
    ...
    assert health["application_version"] == "4.5.0-enterprise"
    assert health["enterprise_foundation"] == "Enterprise Platform v4.4.0-enterprise"
...
async def test_api_port_enterprise(client):
    ...
    assert body["application_version"] == "4.5.0-enterprise"
...
def test_docs_and_regression_15_0():
    ...
    assert "4.5.0-enterprise" in manifest
    assert "15.0" in manifest
