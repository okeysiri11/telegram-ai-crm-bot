...
BUILTIN_MODELS: list[AIModelRecord] = [
    ...
    _model("gemini", "gemini-1.5-flash", "Gemini 1.5 Flash", context_window=1000000, input_price=0.000075, output_price=0.0003),
    ...
    _model(
        ...
        input_price=0.0,
        output_price=0.0,
        capabilities=ModelCapabilities(chat=True, function_calling=True),
    ),
    _model(
        "azure_openai",
        "gpt-4o-mini",
        ...
        input_price=0.00015,
        output_price=0.0006,
        capabilities=ModelCapabilities(chat=True, function_calling=True, streaming=True),
    ),
