...
Production validation and commercial certification for **Auto Marketplace 4.1.7-enterprise**.
...
`applications/auto_marketplace/manifest.json` — `application_version = "4.1.7-enterprise"`, `production_ready = true`
