...
Production validation and commercial certification for **Auto Marketplace 4.1.4-enterprise**.
...
`applications/auto_marketplace/manifest.json` — `application_version = "4.1.4-enterprise"`, `production_ready = true`
