...
Production validation and commercial certification for **Auto Marketplace 4.1.5-enterprise**.

| Field | Value |
|-------|-------|
| Application version | `4.1.5-enterprise` |
...
`applications/auto_marketplace/manifest.json` — `application_version = "4.1.5-enterprise"`, `production_ready = true`
