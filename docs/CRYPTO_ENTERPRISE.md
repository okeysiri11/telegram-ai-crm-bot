...
**API:** `/api/crypto-enterprise/v1` · `/api/crypto-ta/v1` · `/api/crypto-mm/v1` · `/api/crypto-mi/v1` · `/api/crypto-se/v1` · `/api/crypto-rm/v1`

## Foundation

Enterprise foundation for crypto intelligence, market analytics, and digital asset management.

## Capabilities

- Multi-exchange registry and API key management
- Spot, futures, options, and perpetual market data
