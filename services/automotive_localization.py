...
_AUTO_BUTTONS: dict[str, dict[str, str]] = {
    ...
    "client_buy_car": {"ru": "🚘 Купить автомобиль", "uk": "🚘 Купити автомобіль"},
    "client_sell_car": {"ru": "💰 Продать автомобиль", "uk": "💰 Продати автомобіль"},
    "client_listing": {"ru": "📢 Разместить объявление", "uk": "📢 Розмістити оголошення"},
    "client_services": {"ru": "🛠 Автоуслуги", "uk": "🛠 Авто послуги"},
    "client_manager": {"ru": "📞 Менеджер", "uk": "📞 Менеджер"},
}
