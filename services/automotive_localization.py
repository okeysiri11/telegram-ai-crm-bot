...
_TEXTS: dict[str, dict[str, str]] = {
    ...
    # Sprint 46.1 — telegram.auto.* keys (Russian First)
    "telegram.auto.ai_welcome": {
        "ru": (
            "Напишите, что нужно.\n\n"
            "Например:\n"
        ...
        "uk": (
            ...
            "Наприклад:\n"
            "• Знайди BMW X5 в Одесі до $15 000"
        ),
    },
    "telegram.auto.tenant_missing": {
        "ru": "Не удалось определить организацию. Выберите рабочее пространство.",
        "uk": "Не вдалося визначити організацію. Оберіть робочий простір.",
    },
    "telegram.auto.rates_missing": {
        "ru": "Курсы дилера пока не настроены.",
        "uk": "Курси дилера поки не налаштовані.",
    },
    "telegram.auto.rates_missing_owner": {
        "ru": "Курсы дилера пока не настроены.\n\n[⚙ Настроить]",
        "uk": "Курси дилера поки не налаштовані.\n\n[⚙ Налаштувати]",
    },
    "telegram.auto.searching": {
        "ru": "Ищу {query}.",
        "uk": "Шукаю {query}.",
    },
    "telegram.auto.found": {
        "ru": "Нашёл {count} вариант(ов).",
        "uk": "Знайшов {count} варіант(ів).",
    },
    "telegram.auto.monitor_hint": {
        "ru": "🔔 Следить за новыми — напишите «следить».",
        "uk": "🔔 Стежити за новими — напишіть «стежити».",
    },
    "telegram.auto.ai_unavailable": {
        "ru": "AI Менеджер временно недоступен. Попробуйте позже.",
        "uk": "AI Менеджер тимчасово недоступний. Спробуйте пізніше.",
    },
    "telegram.auto.dealer_settings_title": {
        "ru": "⚙ Авто → Настройки дилера",
        "uk": "⚙ Авто → Налаштування дилера",
    },
}
...
_AUTO_BUTTONS: dict[str, dict[str, str]] = {
    ...
    "client_buy_car": {"ru": "🚗 Поиск автомобиля", "uk": "🚗 Пошук автомобіля"},
    "client_sell_car": {"ru": "💰 Продажа автомобиля", "uk": "💰 Продаж автомобіля"},
